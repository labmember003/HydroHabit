package com.falcon.hydrohabit.features.splash_screen
...
fun SplashScreen(modifier: Modifier = Modifier) {
    ...
    Box(modifier = modifier) {
        ...
        Column(
            ...
            Image(
                imageVector = ImageVector.vectorResource(R.drawable.hydrohabit_logo),
                contentDescription = "HydroHabitLogo",
            )
        }
    }
}
